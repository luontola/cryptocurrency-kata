...
(deftest test-parse-account-report-csv
  (is (= [{:portfolio :default
         ...
         (coinbase/parse-account-report-csv
          (str "portfolio,type,time,amount,balance,amount/balance unit,transfer id,trade id,order id\n"
               "default,deposit,2018-02-04T14:48:06.142Z,0.0099876500000000,0.0099876500000000,BTC,8afb99ca-b8c3-4405-b4de-30bf2e7a0c86,,\n"
               "default,match,2018-02-04T21:09:11.089Z,-0.0099876500000000,0.0000000000000000,BTC,,11309314,53d6f6cc-db5e-40d6-aab6-a9e5cc2f0c46\n")))))
